 ...
 * Middleware pour vérifier les permissions de profil
 * 
 * @param {string} profileIdParamName - Nom du paramètre/body contenant le profile_id
 * @param {string[]} rolesAllowed - Liste des rôles autorisés (ex: ['owner', 'admin', 'member'])
 * 
 * Usage:
 ...
 *   );
 */
export const requireProfileRole = (profileIdParamName, rolesAllowed = []) => {
